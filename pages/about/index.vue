    ...
    <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
      <div class="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
        <div class="space-y-5 sm:space-y-4">
          <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Chi siamo</h2>
          <p class="text-xl text-gray-500">
            New Verse è una società che offre servizi blockchain.
            <br>
            Ci concentriamo maggiormente sul mondo NFT
            <nuxt-link to="/services">Esplora i nostri servizi</nuxt-link>
          </p>
        </div>
            ...
            <li v-for="person in people" :key="person.name" class="sm:py-8">
              <div class="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                <div class="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                  <img class="object-cover shadow-lg rounded-full" :src="person.imageUrl" alt="" />
                </div>
...
const people = [
  {
    name: 'Giulio Lora Lamia',
    role: 'Co-Founder / CEO',
    imageUrl:
      '/teams/giulio_circle.png',
    bio:
  ...
  {
    name: 'Aleandro Coppola',
    role: 'Co-Founder / CEO',
    imageUrl:
      '/teams/aleandro_coppola_head_circle.png',
    bio:
      'Ultricies massa malesuada viverra cras lobortis. Tempor orci hac ligula dapibus mauris sit ut eu. Eget turpis urna maecenas cras. Nisl dictum.',
    twitterUrl: '#',
    linkedinUrl: '#',
